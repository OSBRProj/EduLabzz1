...
class CanalProfessorController extends Controller
{
    ...
    public function index($idProfessor)
    {
        ...
        return view('pages.canal_professor.index', compact('podcasts', 'transmissoes', 'professor'));
    }
    ...
    public function biblioteca($idProfessor)
    {
        ...
        return view('pages.canal_professor.biblioteca')->with(compact('conteudos', 'videos', 'slides', 'apostilas', 'documentos', 'aplicacoes', 'professor'));
    }
    ...
    public function avaliacoes($idProfessor)
    {
        ...
        return view('pages.canal_professor.avaliacoes', compact('avaliacoes', 'professor'));
    }
    ...
    public function duvidas($idProfessor)
    {
        ...
        return view('pages.canal_professor.duvidas')->with(compact('duvidas', 'professor', 'avaliacaoInstrutor'));
    }
    ...
    public function duvida($idProfessor, $idDuvida)
    {
        ...
        return view('pages.canal_professor.duvida-respostas')->with(compact('turma', 'duvida', 'avaliacaoInstrutor'));
    }
