...
@section('title', 'J. PIAGET - Dúvida professor')
        ...
        <div class="px-3 w-100">
            ...
            <div class="row">
                <div class="col-12 mr-auto align-middle my-auto text-left">
                    <a href="{{ route( (Request::is('gestao/*') ? 'gestao.' : '') . 'professor.duvidas', $duvida->professor_id) }}" class="btn bg-transparent btn-outline text-primary box-shadow rounded px-4 py-2">
                        <i class="fas fa-chevron-left fa-fw fa-lg mr-2"></i>
                        Voltar ao painel de dúvidas
                    </a>
            ...
            <div class="row mb-5 text-center">
                <div class="col-auto mx-auto">
                        ...
                        <h5 class="text-left font-weight-normal" style="color: #989AC1;">
                            {{ ucfirst($duvida->professor->escola->titulo) }}
                        </h5>
                </div>
            </div>

            <hr class="my-5" style="border-color: #989AC1;">
