...
@section('title', 'J. PIAGET - ' . ucfirst($conteudo->titulo))
...
@section('headend')
    ...
    <style>
        ...
        .conteudo-container
        {
            ...
            /*max-width: 1292px;*/
            /*max-height: 732px;*/
            border: 6px solid #207adc !important;
...
@section('bodyend')
    ...
    <script>
        ...
        function enviarAvaliacaoConteudo(avaliacao)
        {
            ...
            $.ajax({
                url: '{{ env('APP_LOCAL') }}/play/conteudo/{{ $conteudo->id }}/avaliacao/enviar',
                type: 'post',
                data: formData,
        ...
        $(window).on('unload', function() {
            ...
            navigator.sendBeacon('{{ env('APP_LOCAL') }}/play/conteudo/{{ $conteudo->id }}/interacao/enviar', fd);
        });
