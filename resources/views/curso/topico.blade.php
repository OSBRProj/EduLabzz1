...
@section('title', 'J. PIAGET - Tópico ' . $topico->titulo)
        ...
        <div class="px-3 w-100">
            ...
            <div class="row">
                <div class="col-12 mr-auto align-middle my-auto text-left">
                    <a href="{{ route( 'curso', $topico->curso_id) }}" class="btn bg-transparent btn-outline text-primary box-shadow rounded px-4 py-2">
                            ...
                            <div class="col-12 m-0">
                                <form action="{{ route('curso.topico-comentario-enviar', ['curso_id' => $topico->curso_id, 'topico_curso_id' => $topico->id]) }}" method="post">
                                    <div class="input-group" style="font-size: 16px;margin-top:  20px;">
                                        @csrf
                                        <input type="text" id="txtComentarioTopico" class="form-control bg-light box-shadow rounded-10 text-dark mx-auto p-3" name="conteudo" aria-describedby="helpId" placeholder="Escreva um comentário" style="border-right: 0px;font-weight: normal;border-radius: 10px 0px 0px 10px;">
