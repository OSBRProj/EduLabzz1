...
@section('headend')
    ...
    <style>
        body{
            background:  linear-gradient(to bottom, rgba(246, 247, 249, 0.98)  90%, rgba(246, 247, 249, 0.98)  90%), url('{{ env('APP_URL') }}/images/education-pattern.jpg') repeat;
        }
            ...
            <div class="col-10 col-md-10 col-lg-8 mx-auto">
                ...
                <div class="row my-4">
                    ...
                    <div class="col-12 col-md-8 text-center mx-auto">
                        ...
                        <div style="background-image: url('{{ env('APP_LOCAL') . '/uploads/cursos/capas/' .  $curso->capa }}');background-size: cover;background-position: 50% 50%;background-repeat: no-repeat;border:0px;width:100%;height:20vh;position:relative;border-radius:8px;box-shadow: 0px 2px 6px rgba(0,0,0,0.16);">
                        </div>

                        <div class="d-inline-block my-3 align-middle">
                            <i class="fas fa-lock fa-fw fa-2x mb-3 text-danger"></i>
                            <p class="font-weight-bold text-dark">Curso trancado</p>
