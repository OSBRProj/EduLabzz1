            ...
            <div class="container">
                ...
                <div class="col-12 mx-auto">
                    ...
                    <div class="tab-content" id="tabDadosUsuario">
                        ...
                        <div class="tab-pane fade @if(!Request::has('#alunos')) show active @endif" id="mural" role="tabpanel"
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row px-1 px-sm-5">
                                            ...
                                            <div class="bg-card bg-white rounded-0 box-shadow p-4 mb-4">
                                                <div class="custom-control custom-checkbox mb-3">
                                                    <input type="checkbox" class="custom-control-input"
                                                        ...
                                                        onchange="mudouModoPostagemEscola(this);" {{ $escola->postagem_aberta ? 'checked' : '' }}>
                                    ...
                                    <div class="col-12 col-md-8 mx-auto">
                                        ...
                                        <div class="bg-light rounded shadow-sm mb-2">
                                                ...
                                                <div class="container-fluid px-0">
                                                    ...
                                                    <div class="row pl-5 pr-4">
                                                        ...
                                                        <div class="col text-left">
                                                            ...
                                                            <div class="pt-2 text-primary content-mural-escola">
                                                                {!! $postagem->conteudo !!}
                                                            </div>
                                                        ...
                                                        @if($postagem->user_id == Auth::user()->id || $escola->user_id == Auth::user()->id)
                                                            <div class="col-auto ml-auto pr-0 mx-0 text-right">
                                                                <form class=""
                                                                    ...
                                                                    @csrf
                                                                    <button type="submit"
                                                                        class="btn bg-danger p-1 mr-2">
                                                                        <i class="fas fa-trash fa-fw text-light"></i>
                                                                    </button>
                                                                </form>
                                                            </div>
                                                        @endif
                                                            ...
                                                            <form
                                                                ...
                                                                <div class="input-group"
                                                                    ...
                                                                    <div
                                                                        ...
                                                                        style="border-left: 0px;shadow-sm: -3px 3px 6px rgba(0,0,0,0.16);">
                                                                        <button type="submit"
                                                                                onclick="enviarComentarioPostagem({{ $postagem->id }});"
                                                                                class="btn bg-primary btn-block text-light">
