        ...
        <div class="row">
            ...
            <section class="col-12 col-md-11 mx-auto">
                ...
                <div class="my-4">
                    ...
                    <form id="formNovoArtigo" class="w-100" method="POST" action="{{ route('gestao.artigos.atualizar') }}" enctype="multipart/form-data">
                        ...
                        <div class="form-group m-0">
                            <input type="text" class="px-5 pt-3 pt-sm-4 form-control font-weight-bold rounded-0 text-secondary-placeholder text-truncate" name="titulo" value="{{ $artigo->titulo }}" id="titulo" placeholder="Título" style="font-size: 28px;border: 0px; border-bottom: 0px solid #E3E5F0;" required>
                            <input type="text" class="px-5 pt-2 pt-sm-3 pb-3 form-control font-weight-bold rounded-0 text-secondary-placeholder text-truncate" name="subtitulo" value="{{ $artigo->subtitulo }}" id="subtitulo" placeholder="Subtítulo" style="font-size: 18px;border: 0px; border-bottom: 2px solid #E3E5F0;" required>
                        </div>
                            ...
                            <div class="container-fluid">
                                ...
                                <div class="row">
                                    ...
                                    <div class="col-12">
                                        ...
                                        <label for="capa" id="arquivo_capa" class="file-input-area input-capa mt-3 mb-5 w-100 text-center bg-primary" style="background: url({{ env("APP_LOCAL") . '/uploads/artigos/' . $artigo->capa }}); background-size: contain; background-position: 50% 50%; background-repeat: no-repeat;">
                                            <input type="file" class="custom-file-input" id="arquivo_capa" name="arquivo_capa" style="top: 0px;height:  100%;position:  absolute;left:  0px;" accept="image/jpg, image/jpeg, image/png" oninput="mudouArquivoCapa(this);">
                                            ...
                                            <p id="file-name" class="float-left" style="margin-top:160px;margin-bottom:20px;">
                                                Clique acima ou arraste o arquivo para trocar de capa
                                            </p>
                                        </label>

                                        <div class="form-group mb-3">
                                            <label class="" for="descricao">Descrição curta</label>
                                            <textarea class="form-control" name="descricao" id="descricao" rows="3" placeholder="Clique para digitar." required>{{ $artigo->descricao }}</textarea>
                                        </div>
                                        ...
                                        <div class="form-group mb-3">
                                            ...
                                            <select class="custom-select form-control" name="categoria" id="categoria" required>
                                                ...
                                                <option value="1" {{ $artigo->categoria_id == 1 ? 'selected' : '' }}>Geral</option>
                                                @foreach ($categorias as $categoria)
                                                    <option value="{{ $categoria->id }}" {{ $artigo->categoria_id == $categoria->id ? 'selected' : '' }}>{{ ucfirst($categoria->titulo) }}</option>
                                                @endforeach
                                            </select>
                                        </div>

                                        <textarea name="conteudo" id="conteudo" class="summernote" rows="10" placeholder="Escreva aqui seu artigo."></textarea>

                                        <input type="hidden" name="status" value="{{ $artigo->status }}">
                                ...
                                <div class="mt-4 d-flex" style="justify-content: space-between;">
                                    ...
                                    <button type="button" onclick="salvarArtigo(true);" class="btn btn-primary signin-button font-weight-bold px-5">Publicar</button>
                                </div>
...
@section('bodyend')
    ...
    <script>
        ...
        $( document ).ready(function()
        {
            ...
            $(".summernote").summernote("editor.pasteHTML", `{!! $artigo->conteudo !!}`);
        });
