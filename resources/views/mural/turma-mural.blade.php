    ...
    <main role="main">
            ...
            <div class="container-fluid pt-4">
                ...
                <div class="tab-content pt-4 px-1 px-md-4" id="tabDadosUsuario">
                    ...
                    <div class="tab-pane fade px-md-5 show active" id="mural" role="tabpanel"
                        ...
                        <div class="container-fluid">
                            ...
                            <div class="row px-1 px-sm-5">
                                        ...
                                        <div class="bg-card bg-white rounded-0 box-shadow p-4 mb-4">
                                            <div class="custom-control custom-checkbox mb-3">
                                                <input type="checkbox" class="custom-control-input"
                                                       ...
                                                       onchange="mudouModoPostagem(this);" {{ $turma->postagem_aberta ? 'checked' : '' }}>
                                ...
                                <div class="col-12 col-md-8 mx-auto">
                                    ...
                                    <div class="bg-white rounded-0 box-shadow mb-2">
                                            ...
                                            <div class="p-0 mb-3">
                                                ...
                                                <form id="formPostar" method="POST"
                                                    ...
                                                    <div id="divEditar" class="form-page">
                                                        ...
                                                        <textarea name="conteudo" id="txtConteudo" class="summernote-airmode d-none text-dark" onchange="escreveuPostagem();"></textarea>
                                                            </div>
                                                        </div>
                    ...
                    @if(Request::is('gestao/turma/*') && ($turma->user_id == Auth::user()->id || Auth::user()->permissao == "Z"))
                        <div class="tab-pane fade px-md-5" id="aplicacao" role="tabpanel"
                             aria-labelledby="aplicacao-tab">
                                ...
                                <div class="row pt-2">
                                    ...
                                    <div class="col-12 mx-auto" style="max-width: 720px;">
                                        <form id="formLiberarAplicacao"
                                            ...
                                            <h4 class="text-primary text-center mx-auto mt-5 mb-3">
                                                Para quais alunos?
                                            </h4>
                        ...
                        <div class="tab-pane fade px-md-5" id="transmissao" role="tabpanel"
                             aria-labelledby="transmissao-tab">
                                ...
                                <div class="row pt-2">
                                    ...
                                    <div class="col-12 mx-auto" style="max-width: 720px;">
                                        <form id="formNovaTransmissao"
                                            ...
                                            <h4 class="text-primary text-left mx-auto mb-3">
                                            ...
                                            <div class="form-group mb-3 text-left">
                                                <label class="text-primary" for="txtCodigoTransmissao">Código da
                                                    transmissão</label>
                                            ...
                                            <button type="button" onclick="gerarToken();"
                                                    class="btn btn-primary font-weight-bold px-2 mb-3 text-white text-uppercase">
                                                GERAR CÓDIGO
                                            </button>

                                            <div class="form-group mb-3 text-left">
                                                <label class="text-primary" for="txtDescricaoTransmissao">Descrição da
                                                    transmissão
                                            ...
                                            <button type="submit"
                                                    class="btn btn-primary font-weight-bold px-4 text-white text-uppercase float-right mb-3">
                                                CRIAR TRANSMISSÃO
                                            </button>
                                    ...
                                    <div class="container-fluid" style="max-width: 720px;">
                                        ...
                                        <div class="row">
                                            @foreach ($transmissoes as $transmissao)
                                                <div id="divTransmissao{{ $transmissao->id }}"
                                                    ...
                                                    <div class="card rounded-10 text-decoration-none h-100 border-0">
                                                        <div class="py-3 px-4 h-100"
                                                             style="color: #525870;font-size: 16px;flex: 1;">
                    ...
                    <div class="tab-pane fade px-md-5" id="alunos" role="tabpanel" aria-labelledby="alunos-tab">

                        <div class="container-fluid">

                            <div class="row px-5 mb-4">
                                <div class="col align-middle my-auto px-0">
                                    ...
                                    @if(Request::is('gestao/turma/*') && ($turma->user_id == Auth::user()->id || Auth::user()->permissao == "Z"))
                                        ...
                                        <div id="divLinkConvite2"
                                             class="input-group mb-3 {{ $turma->codigo_convite != null ? '' : 'd-none' }}">
                                            <div id="lblLinkConvite2"
                                                 class="form-control bg-card border-0 rounded-0 text-wrap">
                                ...
                                @if(Request::is('gestao/turma/*') && ($turma->user_id == Auth::user()->id || Auth::user()->permissao == "Z"))
                                    <div class="col-auto ml-auto align-middle pr-0">
                                                ...
                                                <div class="modal-body">
                                                    ...
                                                    <form id="formConvidarAlunos" method="POST"
                                                        ...
                                                        <div id="divEditar" class="form-page">
                                                            ...
                                                            <h4 class="mb-4">Convidar alunos</h4>
                                                            ...
                                                            <div id="divLinkConvite3"
                                                                 class="text-left mt-2 mb-3 {{ $turma->codigo_convite != null ? '' : 'd-none' }}">
                                                            ...
                                                            <button type="button"
                                                                    ...
                                                                    class="btn btn-link btn-block text-primary font-weight-bold">
                                                                Adicionar campo
                                                            </button>
                                                            ...
                                                            <div class="row">
                                                                ...
                                                                <button type="submit" onclick="criarTurma();"
                                                                        class="btn btn-lg bg-bluelight btn-block signin-button mt-4 mb-0 col-4 ml-4 mr-auto text-dark font-weight-bold">
                                                                    Enviar
                                                                </button>
                                                            </div>
        ...
        <!-- Bootstrap Select JavaScript -->
            ...
            <script>
                ...
                function mudouModoPostagem(ckb) {
                    $.ajax({
                        url: '{{ route('gestao.turma-modo-postagem', ['idTurma' => $turma->id]) }}',
                        type: 'get',
                        dataType: 'json',
