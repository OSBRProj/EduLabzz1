...
@section('title', 'J. PIAGET - Dúvidas professor')
                                    ...
                                    <div id="divEditar" class="form-page">
                                        ...
                                        <div id="page1" class="form-page">
                                            ...
                                            <div class="form-group mb-4 text-left">
                                                ...
                                                <textarea class="form-control" name="descricao" id="txtDescricaoNovoConteudo" rows="3" placeholder="Clique para digitar." required></textarea>
                                            </div>
                                            ...
                                            <div class="row">
                                                ...
                                                <button type="submit" onclick="$('#formNovaDuvida')[0].checkValidity() ? enviarDuvida() : event.preventDefault();" class="btn btn-lg bg-bluelight btn-block signin-button mt-4 mb-0 col-4 ml-4 mr-auto text-dark font-weight-bold">Criar</button>
                                            </div>
