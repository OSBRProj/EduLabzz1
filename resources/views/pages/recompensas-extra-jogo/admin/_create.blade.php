<!-- Modal -->
<div class="modal fade" id="ModalCreateRecompensaExtraJogo" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-3">
            <h2 class="font-weigth-bold">Recompensa Extra-Jogo</h2>

            <form class="mt-2" id="form_recompensa_extra_jogo" action="{{ route('gestao.recompensas-extra-jogo.cadastrar') }}" method="post" enctype="multipart/form-data">
                @csrf
