<div class="modal-edit-audio-interacao modal fade" id="divModalEditAudioInteracao_{{$interacao->id}}" tabindex="-1" role="dialog" aria-hidden="true">
        ...
        <div class="modal-content">
            <div class="modal-body">
                ...
                <div class="my-1">
                    ...
                    <h4 class="text-center">Atualizar Interação de Áudio</h4>

                    <form id="formEditAudioInteracao" class="w-100"
                          action="{{ route('gestao.audios-interacoes.update', ['idAudioInteracao' => $interacao->id]) }}"
                          method="post"
                        ...
                        <div class="row-seekbar row mb-3 d-flex align-items-center">
                            <div class="col-lg-3 col-12">
                                <input type="text" class="txtTempoAudioInteracao form-control" name="inicio"
                                       placeholder="Tempo" value="{{ $interacao->inicio }}" readonly>
                            </div>
                        ...
                        <div class="row mb-3">
                            <div class="col-lg-12 col-12">
                                <input type="text" class="form-control" name="titulo"
                                       placeholder="Título da Interação" value="{{ $interacao->titulo }}">
                            </div>
                        </div>
                        <div class="row mb-3">
                            <div class="col-lg-12 col-12">
                                <textarea class="form-control" name="descricao" placeholder="Descrição" rows="6">{{ $interacao->descricao }}</textarea>
                            </div>
                        </div>
