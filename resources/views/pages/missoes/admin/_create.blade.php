<!-- Modal -->
<div class="modal fade" id="ModalCreateMissao" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-3">
            <h2 class="font-weigth-bold">Criar Missão</h2>

            <form class="mt-2" id="form_missao" action="{{ route('gestao.missoes.cadastrar') }}" method="post" enctype="multipart/form-data">
                @csrf
