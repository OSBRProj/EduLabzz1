<!-- Modal -->
<div class="modal fade" id="ModalCreateRecompensaVirtual" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
aria-hidden="true">
    <div class="modal-dialog modal-lg" role="document">
        <div class="modal-content p-3">
            <h2 class="font-weigth-bold">Recompensa Virtual</h2>

            <form class="mt-2" id="form_recompensa_virtual" action="{{ route('gestao.recompensas-virtuais.cadastrar') }}" method="post" enctype="multipart/form-data">
                @csrf
